...
include "config.php";
    if(isset($_POST['sub']))
 {
    ...
    $sql="select * from `coordinator2` where `name`='".$name."' && `year`='".$year."'";
    ...
    $image=imagecreatefromjpeg("images/certi4.JPG");
    $Color = imagecolorallocate($image,51, 51, 102);

    $name        =  $_POST['name'];
    imagettftext($image,26, 0, 480, 270, $Color, $font, $name);
    $year    =  $_POST['year'];
    imagettftext($image,18, 0, 430, 322, $Color, $font1, $year);
          ...
          <div class="card-body">
            <form id="form" method="post" enctype="multipart/form-data">
              ...
              <div class="form-group">
                ...
                <input type="text" name="year" autocomplete="off" class="form-control" placeholder="ECE 2nd YEAR">
              </div>
              <div class="form-group">
